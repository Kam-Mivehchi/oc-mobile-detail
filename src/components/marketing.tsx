...
export default function Marketing() {
   return (
      <section className=" px-2 sm:px-6 lg:px-8  flex flex-col items-center  gap-8 text-center">
         ...
         <p className="text-lg px-4 lg:px-16">{marketingContent.intro1}<span className="text-accent font-bold">{marketingContent.company}</span> {marketingContent.intro2}</p>
      </section>
   )
}
