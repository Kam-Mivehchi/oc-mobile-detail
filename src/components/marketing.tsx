...
export default function Marketing() {
   return (
      <section className=" px-2 sm:px-6 lg:px-8  flex flex-col items-center  gap-8 text-center pb-24">
         <h1 className="text-4xl font-bold">{marketingContent.header}</h1>
         <p className="md:text-xl px-4 lg:px-16 leading-8">{marketingContent.intro1}<span className="text-accent font-bold">{marketingContent.company}</span> {marketingContent.intro2}</p>
      </section>
   )
}
