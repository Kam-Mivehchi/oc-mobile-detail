...
function About() {
   ...
   return (<Transition as="main" className="max-w-[1280px] mx-auto transition-all duration-700 text-white px-2 sm:px-6 lg:px-8 flex flex-col gap-6 pt-10 text-center"
      ...
      <p className=" leading-8 md:text-xl lg:text-2xl"> OC Mobile Detailing is one of the most established and top-rated auto detailing that you will find around in Orange County.
      </p>
      <p className=" leading-8 md:text-xl lg:text-2xl" >Whether you have lived in Irvine, Newport Beach, or Lake Forest for your entire life, or you have recently moved here, you know that our master-planned city is one of the most popular for people to call home in Orange County. With a population exceeding 260,000, we are also one of the quickest growing cities in SoCal making the full range of car wash services often seeing a fair amount of competition to just get an appointment on a normal weekend.
      </p>
      <p className="leading-8 md:text-xl lg:text-2xl">
